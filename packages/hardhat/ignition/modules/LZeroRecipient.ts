...
const LZeroRecipientModule = buildModule("LZeroRecipientModule", m => {
  const lZeroRecipient = m.contract("LZeroRecipient", [
  ...
  return { lZeroRecipient };
});

export default LZeroRecipientModule;
